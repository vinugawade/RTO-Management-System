...
if (mysqli_num_rows($result2) > 0) {
    ...
    if ($row2[7] == 1) {
        echo "<br><br>&emsp; &emsp;Your DL Status: Approved";
    } else if ($row2[7] == -1) {
        echo "<br><br>&emsp; &emsp;Your DL Status: Rejected, apply for DL again!!";
    } else {
        echo "<br><br>&emsp; &emsp;Your DL Status: Not yet approved";
    }
} else {
